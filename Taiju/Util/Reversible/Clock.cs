...
namespace Taiju.Util.Reversible;

public class Clock {
  public const uint HistoryLength = 256;
  public const double TickTime = 1.0 / 60.0;
  ...
  private void DebugBranch() {
    ...
    GD.PrintRich($"Leaping {CurrentLeap} at {CurrentTick}. branches: [{branches}]");
  }
