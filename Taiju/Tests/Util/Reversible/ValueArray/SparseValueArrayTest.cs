...
[TestSuite]
public class SparseValueArrayTest : ValueArrayTestBase<SparseArray<int>> {
  protected override SparseArray<int> Create(Clock clock, int initial) => new(clock, 2, initial);
